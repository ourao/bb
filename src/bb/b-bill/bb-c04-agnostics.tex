...
\bbHeading{BB. WE AGNOSTICS p. 44-57}
\bbChapterPreamble
...
\verse We hope we have made clear the distinction 
    between the alcoholic and the nonalcoholic. 
\verse If, when you honestly want to, you find you cannot quit entirely, 
    or if when drinking, you have little control over the amount you take, 
    you are probably alcoholic. 
\verse If that be the case, 
    you may be suffering from an illness 
    which only a spiritual experience will conquer.

\verse To one who feels he is an atheist or agnostic 
    such an experience seems impossible, 
    but to continue as he is means disaster, 
    especially if he is an alcoholic of the hopeless variety. 
\verse To be doomed to an alcoholic death 
    or to live on a spiritual basis 
    are not always easy alternatives to face.

\verse But it isn't so difficult. 
\verse About half our original fellowship were of exactly that type. 
\verse At first some of us tried to avoid the issue, 
    hoping against hope we were not true alcoholics. 
\verse But after a while we had to face the fact 
    that we must find a spiritual basis of life-or else.
\verse Perhaps it is going to be that way with you.
\verse But cheer up, 
    something like half of us thought we were atheists or agnostics. 
\verse Our experience shows that you need not be disconcerted.

\verse If a mere code of morals 
    or a better philosophy of life were sufficient to overcome alcoholism, 
    many of us would have recovered long ago. 
\verse But we found that such codes and philosophies did not save us, 
    no matter how much we tried. 
\verse We could wish to be moral, 
...
\verse Our human resources, as marshalled by the will, were not sufficient; 
    they failed utterly.

\verse Lack of power, that was our dilemma. 
\verse We had to find a power by which we could live, 
    and it had to be a Power greater than ourselves. 
\verse Obviously. 
\verse But where and how were we to find this Power?
\end{biblechapter}
